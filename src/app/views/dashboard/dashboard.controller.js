(function () {
     ...
     * @constructor
     */
    DashboardController.$inject = ['$scope', '$window', '$log', '$mdSidenav', '$localStorage', 'api', '$mdSelect', '$http', 'appConfig', '$timeout'];
    function DashboardController($scope, $window, $log, $mdSidenav, $localStorage, api, $mdSelect, $http, appConfig, $timeout) {
        var vm = this;
        ...
        vm.toolbarTitle = "Feature / Result Viewer";
        vm.selected = null;
        ...
        $scope.searchQuerySubmit = function(){
            ...
            // var req = {
            //     method: 'POST',
            //     url: 'http://iti-386.iti.gr:4570/query',
            //     headers: {
            ...
            $http(req).then(x => {
                ...
                let req = {
                        method: 'POST',
                        url: 'http://160.40.50.208:7777/activage_proxy/index.php?path=ActivageTranslator/JsonTranslator',
                        headers: {
                            'Content-Type': 'application/json'
                        },
        ...
        $scope.analyseData = function () {
            ...
            if(url.indexOf("http") == -1) {
                finalUrl = appConfig.getConfig('apiAnalyticsUrl') + url;
            }
